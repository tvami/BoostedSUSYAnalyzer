...
/*
  ...
  analysis_cuts['p'].push_back({ .name="MR_R2",    .func = []  { return MR>=800 && R2_1vl>=0.08;     }});
  ...
  analysis_cuts['D'].push_back({ .name="MR_R2",    .func = []  { return MR>=800 && R2_1vl>=0.08;     }});
  ...
  analysis_cuts['d'].push_back({ .name="MR_R2",      .func = []  { return MR>=800 && R2>=0.08;  }});
  analysis_cuts['d'].push_back({ .name="HLT",   .func = [this,&d]  { return isData ? d.HLT_AK8PFJet450==1 || d.HLT_PFHT800==1 || d.HLT_PFHT900==1 : 1; }});
  analysis_cuts['d'].push_back({ .name="1Lep",       .func = []    { return nLepTest==1 && (dR_2D > 0.4 || rel_pT_2D > 25); }});
