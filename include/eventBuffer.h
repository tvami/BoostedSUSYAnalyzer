...
// Created:     Wed Sep  4 14:42:32 2019 by mkanalyzer.py v2.0.2 15-Apr-2019
...
struct eventBuffer
{
  ...
  void initBuffers()
  {
    ...
    GenPart_eta	= std::vector<float>(320,0);
    GenPart_genPartIdxMother	= std::vector<int>(320,0);
    GenPart_mass	= std::vector<float>(320,0);
    GenPart_pdgId	= std::vector<int>(320,0);
    GenPart_phi	= std::vector<float>(320,0);
    GenPart_pt	= std::vector<float>(320,0);
    ...
    SubJet_btagCMVA	= std::vector<float>(35,0);
    SubJet_btagCSVV2	= std::vector<float>(35,0);
    SubJet_btagDeepB	= std::vector<float>(35,0);
    SubJet_eta	= std::vector<float>(35,0);
    SubJet_mass	= std::vector<float>(35,0);
    SubJet_n2b1	= std::vector<float>(35,0);
    SubJet_n3b1	= std::vector<float>(35,0);
    SubJet_phi	= std::vector<float>(35,0);
    SubJet_pt	= std::vector<float>(35,0);
    SubJet_rawFactor	= std::vector<float>(35,0);
    SubJet_tau1	= std::vector<float>(35,0);
    SubJet_tau2	= std::vector<float>(35,0);
    SubJet_tau3	= std::vector<float>(35,0);
    SubJet_tau4	= std::vector<float>(35,0);
