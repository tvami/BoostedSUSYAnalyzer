...
//   h_rel_pT_dR_min_untag = new TH2D("rel_pT_dR_min_untag", ";dR_{min}(l, jet);p_{T, rel}(l, jet)", 40,0,2,40,0,100);
  ...
  h_jet2_pt = new TH1D("jet2_pt",";p_{T, jet2} (GeV)",200,0,2000);
  h_jet3_pt = new TH1D("jet3_pt",";p_{T, jet3} (GeV)",200,0,2000);
  ...
  h_tau21_S_nj35 = new TH1D("tau21_S_nj35", ";tau_{21}", 200,0,1);
  h_tau32_S_nj35 = new TH1D("tau32_S_nj35", ";tau_{32}", 200,0,1);
  ...
  h_tau21_Z_nj35 = new TH1D("tau21_Z_nj35", ";tau_{21}", 200,0,1);
  h_tau32_Z_nj35 = new TH1D("tau32_Z_nj35", ";tau_{32}", 200,0,1);
  ...
  h_tau21_L_nj35 = new TH1D("tau21_L_nj35", ";tau_{21}", 200,0,1);
  h_tau32_L_nj35 = new TH1D("tau32_L_nj35", ";tau_{32}", 200,0,1);
  ...
  h_tau21_G_nj35 = new TH1D("tau21_G_nj35", ";tau_{21}", 200,0,1);
  h_tau32_G_nj35 = new TH1D("tau32_G_nj35", ";tau_{32}", 200,0,1);
  ...
  h_MR_Q_nj35 = new TH1D("MR_Q_nj35",   ";M_{R,AK4} (GeV)",         nbn_MR,bn_MR);
  h_R2_Q_nj35 = new TH1D("R2_Q_nj35",   ";R^{2}_{AK4}",         nbn_R2,bn_R2);
  h_tau21_Q_nj35 = new TH1D("tau21_Q_nj35", ";tau_{21}", 200,0,1);
  h_tau32_Q_nj35 = new TH1D("tau32_Q_nj35", ";tau_{32}", 200,0,1);
  ...
  h_MR_T_nj35 = new TH1D("MR_T_nj35",   ";M_{R,AK4} (GeV)",         nbn_MR,bn_MR);
  h_R2_T_nj35 = new TH1D("R2_T_nj35",   ";R^{2}_{AK4}",         nbn_R2,bn_R2);
  h_tau21_T_nj35 = new TH1D("tau21_T_nj35", ";tau_{21}", 200,0,1);
  h_tau32_T_nj35 = new TH1D("tau32_T_nj35", ";tau_{32}", 200,0,1);
  ...
  h_MR_W_nj35 = new TH1D("MR_W_nj35",   ";M_{R,AK4} (GeV)",         nbn_MR,bn_MR);
  h_R2_W_nj35 = new TH1D("R2_W_nj35",   ";R^{2}_{AK4}",         nbn_R2,bn_R2);
  h_tau21_W_nj35 = new TH1D("tau21_W_nj35", ";tau_{21}", 200,0,1);
  h_tau32_W_nj35 = new TH1D("tau32_W_nj35", ";tau_{32}", 200,0,1);
...
//   bool isJetHT = TString(sample).Contains("JetHT");
  ...
  //else { proceed=true;}
  if (!(data.MET_phi<-0.6 && data.MET_phi>-1.8)&&data.MET_pt>150) proceed=true;
  if ( proceed) {
  if (syst_index == 0) {
...
//       h_nIsoTrack->Fill(data.IsoTrack.size(), w);
      ...
      h_jet2_pt->Fill(data.Jet[iJet[1]].pt, w);
      h_jet3_pt->Fill(data.Jet[iJet[2]].pt, w);
    }
